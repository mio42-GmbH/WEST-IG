# KBV_VS_WEST_Diagnosekategorie - Arbeitsgruppe WeST v1.0.0-kommentierung
...
* **KBV_VS_WEST_Diagnosekategorie**

## ValueSet: KBV_VS_WEST_Diagnosekategorie 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.kbv.de/ValueSet/KBV_VS_WEST_Diagnosekategorie | *Version*:1.0.0-kommentierung |
| Draft as of 2026-03-18 | *Computable Name*:KBV_VS_WEST_Diagnosekategorie |
...
```json
{
  ...
  "id" : "KBV-VS-WEST-Diagnosekategorie",
  "url" : "https://fhir.kbv.de/ValueSet/KBV_VS_WEST_Diagnosekategorie",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://fhir.kbv.de/CodeSystem/KBV_CS_WEST_Diagnosekategorie"
    }]
  }
}
