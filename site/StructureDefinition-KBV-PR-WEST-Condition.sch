...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile KBV_PR_Base_Condition_Diagnosis
  ...
  <sch:pattern>
    <sch:title>f:Condition/f:onset[x]/f:low 1</sch:title>
    <sch:rule context="f:Condition/f:onset[x]/f:low">
      <sch:assert test="count(f:comparator) &lt;= 0">comparator: maximum cardinality of 'comparator' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Condition/f:onset[x]/f:high 1</sch:title>
    <sch:rule context="f:Condition/f:onset[x]/f:high">
      <sch:assert test="count(f:comparator) &lt;= 0">comparator: maximum cardinality of 'comparator' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:Condition/f:abatement[x]/f:low 1</sch:title>
    <sch:rule context="f:Condition/f:abatement[x]/f:low">
      <sch:assert test="count(f:comparator) &lt;= 0">comparator: maximum cardinality of 'comparator' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Condition/f:abatement[x]/f:high 1</sch:title>
    <sch:rule context="f:Condition/f:abatement[x]/f:high">
      <sch:assert test="count(f:comparator) &lt;= 0">comparator: maximum cardinality of 'comparator' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
