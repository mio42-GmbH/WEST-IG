...
* Anschließend wird das fertig gestellte Arbeitspaket einem Review unterzogen. Bei diesem ist es möglich, Änderungsvorschläge und Hinweise einzubringen. Der Review ist frei zugänglich und erstreckt sich über 3 Wochen. Es erfolgt eine Kommentierung per Excel-Dateien zu dem bereitgestellten Informationsmodell im [Implementation Guide](/spaces/WEST1X0X0/pages/395640872/Pilotphase) und den FHIR Ressourcen auf der Plattform [simplifier](https://simplifier.net/arbeitsgruppe-west).
